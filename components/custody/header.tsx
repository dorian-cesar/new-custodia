    ...
    <>
      <header className="flex items-center justify-between px-6 py-4 bg-white border-b-2 border-zinc-300">
        ...
        <div className="text-center flex-1">
          ...
          <p className="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider flex items-center justify-center gap-2">
            <span>Sistema de Control de Casilleros</span>
            <span className="bg-[#1588b3]/10 text-[#1588b3] px-1.5 py-0.5 rounded text-[9px] font-bold border border-[#1588b3]/20">v1.2</span>
          </p>
        </div>
