      ...
      <div className="min-h-screen bg-zinc-100 flex items-center justify-center p-4 font-sans select-none">
        <div className="bg-[#d7d7d8] w-full max-w-md rounded-lg border border-zinc-400 shadow-xl overflow-hidden flex flex-col pb-6">
          ...
          <div className="px-6 py-8 flex flex-col items-center gap-4 text-center">
            ...
            <p className="text-zinc-700 font-bold text-sm uppercase tracking-wider">Conectando a base de datos...</p>
            <p className="text-[10px] text-zinc-500 font-semibold">Por favor, espere mientras se establece la conexión con el servidor.</p>
          </div>
        </div>
      </div>
    );
